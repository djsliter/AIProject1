    ...
    def runGame(self):
        ...
        while True:
            ...
            with open('manualsave.csv', 'a') as f:
                f.write(str(distance_from_head_x_to_food_x) + ',' + str(distance_from_head_y_to_food_y)+ ',' + str(last_x_dist_head_to_food) + ',' + str(last_y_dist_head_to_food) + ',' + str(normalized_dir_x) + ',' + str(normalized_dir_y) + ',' + str(direction_x) + ',' + str(direction_y) + ',' + str(up_safe) + ',' + str(down_safe) + ',' + str(left_safe) + ',' + str(right_safe) + ',' + str(decision) + '\n')
            f.close()
